...
TEST(Classes, InheritFromBoolean) {
    test_failing_cellox_program("class/inherit_from_bool.clx",
                                "Superclass must be a class but is a boolean value\n[line 2] in script\n");
}

TEST(Classes, InheritFromFunction) {
    test_failing_cellox_program("class/inherit_from_function.clx",
                                "Superclass must be a class but is a closure object\n[line 2] in script\n");
}

TEST(Classes, InheritFromInstance) {
    test_failing_cellox_program("class/inherit_from_instance.clx",
                                "Superclass must be a class but is a Foo object\n[line 3] in script\n");
}
...
TEST(Classes, InheritFromNull) {
    test_failing_cellox_program("class/inherit_from_null.clx",
                                "Superclass must be a class but is a undefiened value\n[line 2] in script\n");
}

TEST(Classes, InheritFromNumber) {
    test_failing_cellox_program("class/inherit_from_number.clx",
                                "Superclass must be a class but is a numerical value\n[line 2] in script\n");
}

TEST(Classes, InheritSelf) {
    test_failing_cellox_program("class/inherit_self.clx",
