...
{
    test_failing_cellox_program("indexOperator/with_class.clx", "Operands must a number and a string\n[line 3] in script\n");
}

TEST(IndexOperator, WithFunction)
{
    test_failing_cellox_program("indexOperator/with_function.clx", "Operands must a number and a string\n[line 3] in script\n");
}

TEST(IndexOperator, WithNull)
{
    test_failing_cellox_program("indexOperator/with_null.clx", "Operands must a number and a string\n[line 2] in script\n");
}

TEST(IndexOperator, WithString)
{
    test_failing_cellox_program("indexOperator/with_string.clx", "Operands must a number and a string\n[line 2] in script\n");
}