...
/// @brief Resolves all the escape sequences specified in a string literal and returns an int that indicates whether an excape sequence in the string were valid
